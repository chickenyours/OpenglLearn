...
void printBinaryData(const unsigned char* data, size_t size) {
...
unsigned int loadTexture(char const* path) {
    ...
    if (data) {
        // Print the first 64 bytes of image data as binary
        printBinaryData(data, 64);
...
glm::vec3 cubePositions[] = {
    ...
    //const char* texturePath = "models/Oil_barrel/textures/Oil_barrel_Albedo.png"; // 替换为你的图片路径
    const char* texturePath = "models/stairs/StairsLat/obj/CNCR03L.JPG"; // 替换为你的图片路径
