...
namespace Render{
    ...
    void Material::LoadParameterFromConfigFile(const Json::Value& materialJson){
        ...
        // Load shader program
        std::string shaderProgramPath = materialJson["shaderProgramPath"].asString();
        shaderProgram = new ShaderProgram(shaderProgramPath + ".vs", shaderProgramPath + ".fs");  //ShaderManager::GetInstance().LoadShader(shaderProgramPath);
