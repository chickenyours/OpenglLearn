...
set "ENGINE_ROOT=%PROJECT_ROOT%\Engine"
set "AST_EXE=%ENGINE_ROOT%\tools\code_analyst\only_derived.exe"
...
set "ENGINE_INCOUDE_PATH=%ENGINE_ROOT%\include"
