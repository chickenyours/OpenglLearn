...
glm::vec3 cubePositions[] = {
    ...
    MyTool::Model m("models/planet/planet.obj");
    ...
    ShaderProgram BPR("Final/baserender.vs","Final/BPR.fs");
    BPR.Use();
    ...
    ShaderUvec3(BPR, "albedo", glm::vec3(1.0f, 0.0f, 0.0f));
    ShaderU1f(BPR, "metallic", 0.5f);
    ShaderU1f(BPR, "roughness", 0.5f);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for(unsigned int i = 0; i < 10; i++)
        {
            ...
            ShaderUmatf4(BPR,"model",glm::translate(model, cubePositions[i]));
            m.Draw();
        }
