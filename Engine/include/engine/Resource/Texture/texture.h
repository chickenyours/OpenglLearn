...
//         "textureType": "Cube",
// "args":{
//     "posX":"./skybox/right.jpg",
//     "negX":"./skybox/left.jpg",
//     "posY":"./skybox/top.jpg",
//     "negY":"./skybox/bottom.jpg",
//     "posZ":"./skybox/front.jpg",
//     "negZ":"./skybox/back.jpg",
...
namespace Resource {
    ...
    // ===== TextureCube 框架 =====
    class TextureCube : public ILoadFromConfig {
    public:
        bool LoadFromConfigFile(const std::string& configFile, Log::StackLogErrorHandle errHandle = nullptr) override;
    ...
    private:
        GLuint id_ = 0;
        uint32_t textureType_ = GL_TEXTURE_CUBE_MAP;
    };
